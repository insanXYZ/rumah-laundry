...
export const EditOrderButton = ({ values }: { values: ListOrders }) => {
  ...
  const defaultValues: z.infer<typeof EditOrderSchema> = {
    customer_id: values.customer_id.toString(),
  ...
  const onSubmit = (body: z.infer<typeof EditOrderSchema>) => {
    mutate({
      body: body,
            ...
            <FieldGroup>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectGroup>
                              ...
                              <SelectItem value="beres">BERES</SelectItem>
                            </SelectGroup>
                          </SelectContent>
                        </Select>
                      </FormControl>
              ...
              <Field>
                <DialogFooter>
                  ...
                  <ButtonLoading isLoading={false} label="Simpan" />
                </DialogFooter>
              </Field>
            </FieldGroup>
          </form>
